/**
 * @mdxui/admin Wrapper Components
 *
 * These components wrap @mdxui/admin pure UI components with react-admin context,
 * enabling seamless integration with shadmin's data layer.
 */
...
export { MdxSimpleForm, type MdxSimpleFormProps } from './MdxSimpleForm'
